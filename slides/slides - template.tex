...
\begin{tikzpicture}[overlay,remember picture]
 \node[notice={(1,-0.5)}, text width=6.5cm] at (3.5,0) {What makes a good will good? It isn't what it brings about, its usefulness in achieving some intended end. Rather, good will is good because of how it wills -- i.e. it is good in itself. Taken just in itself it is to be valued incomparably more highly than anything that could be brought about by it in the satisfaction of some preference!};
 \node[] at (10,-1.5) {\includegraphics[width=3cm]{kant}};
\end{tikzpicture}
